...
public enum Bases {
	...
	FRIENDLY_FORTRESS(new Fortress(0,GamePanel.SCREENSIZE.height-600,170,600,1000,true)),
	ENEMY_FORTRESS(new Fortress(GamePanel.SCREENSIZE.width-170,GamePanel.SCREENSIZE.height-600,170,600,1000,false));
