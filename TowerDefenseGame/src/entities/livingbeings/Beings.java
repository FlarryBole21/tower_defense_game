...
public enum Beings {
	...
	FRIENDLY_NORMAL_LIZARD(new NormalLizard(Bases.FRIENDLY_CAVE.getBase().getRect().getWidth()-70, 570, 100, 100, 10, 11200, true)),
	...
	FRIENDLY_INTERMEDIATE_LIZARD(new IntermediateLizard(Bases.FRIENDLY_CAVE.getBase().getRect().getWidth()-70, 570, 100, 100, 20, 700, true)),
	ENEMY_INTERMEDIATE_LIZARD(new IntermediateLizard(GamePanel.SCREENSIZE.width-Bases.ENEMY_CAVE.getBase().getRect().getWidth()-30,
			570, 100, 100, 20, 700, false)),
