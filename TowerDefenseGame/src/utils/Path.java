...
public enum Path {
    ...
    IMAGE_ADVANCED_LIZARD_PLAYER_WALK("img/lifeforms/lizard_17.gif"),
    IMAGE_ADVANCED_LIZARD_PLAYER_ATTACK("img/lifeforms/lizard_18.gif"),
    IMAGE_ADVANCED_LIZARD_PLAYER_DEATH("img/lifeforms/lizard_19.gif"),
    IMAGE_ADVANCED_LIZARD_PLAYER_WAIT("img/lifeforms/lizard_20.gif"),
    IMAGE_ADVANCED_LIZARD_ENEMY_WALK("img/lifeforms/lizard_21.gif"),
    IMAGE_ADVANCED_LIZARD_ENEMY_ATTACK("img/lifeforms/lizard_22.gif"),
    IMAGE_ADVANCED_LIZARD_ENEMY_DEATH("img/lifeforms/lizard_23.gif"),
    IMAGE_ADVANCED_LIZARD_ENEMY_WAIT("img/lifeforms/lizard_24.gif"),
    IMAGE_NORMAL_SPIDER_PLAYER_WALK("img/lifeforms/spider_01.gif"),
    IMAGE_NORMAL_SPIDER_PLAYER_ATTACK("img/lifeforms/spider_02.gif"),
    IMAGE_NORMAL_SPIDER_PLAYER_DEATH("img/lifeforms/spider_03.gif"),
    IMAGE_NORMAL_SPIDER_PLAYER_WAIT("img/lifeforms/spider_04.gif"),
    IMAGE_NORMAL_SPIDER_ENEMY_WALK("img/lifeforms/spider_05.gif"),
    IMAGE_NORMAL_SPIDER_ENEMY_ATTACK("img/lifeforms/spider_06.gif"),
    IMAGE_NORMAL_SPIDER_ENEMY_DEATH("img/lifeforms/spider_07.gif"),
    IMAGE_NORMAL_SPIDER_ENEMY_WAIT("img/lifeforms/spider_08.gif"),
    ...
    IMAGE_ICON_ADVANCED_LIZARD("img/lifeforms_icons/advanced_lizard.png"),
    IMAGE_ICON_NORMAL_SPIDER("img/lifeforms_icons/normal_spider.png"),
    IMAGE_ICON_NORMAL_BEAR("img/lifeforms_icons/normal_bear.png"),
    COIN_IMG("img/others/gold_coin.png"),
	...
	SPIDER_ATTACK_SOUND("audio/SpiderAttack.wav"),
