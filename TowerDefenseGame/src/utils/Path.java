...
public enum Path {
    ...
    IMAGE_CAVE_TOWER_01_PLAYER("img/towers/gif/cave_tower_01.gif"),
    IMAGE_CAVE_TOWER_02_PLAYER("img/towers/gif/cave_tower_03.gif"),
    IMAGE_CAVE_TOWER_ROCK_PLAYER("img/towers/pics/cave_tower_rock_02.png"),
